...
const REQUIRED_KEYS = [
  ...
  "satellite.anomaly.banner",
  "satellite.beams.empty",
  "satellite.beams.title",
  "satellite.handover.empty",
  "satellite.handover.failure",
  "satellite.handover.preparing",
  "satellite.handover.title",
  ...
  "satellite.sparkline.empty",
  "satellite.sparkline.title",
  "satellite.subtitle",
  "satellite.timeline.title",
