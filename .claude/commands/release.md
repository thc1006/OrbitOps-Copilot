...
allowed-tools: Read, Grep, Glob, Edit, Bash(./verify.sh), Bash(make package-zip), Bash(scripts/check-no-secrets.sh:*), Bash(exiftool:*), Bash(git tag:*), Bash(git log:*), Bash(gh api:*)
---
...
5. **Package**: `make package-zip` → `orbitops-copilot.zip` at repo parent.
