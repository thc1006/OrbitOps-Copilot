# AC-S005-2 — Performance SLO baselines + CI gate

| Field | Value |
|---|---|
| Parent SPEC | SPEC-S005-2 |
| Sprint | 4 (VS-20) |
...
### AC-S005-2.1 — k6 scripts exist and run
...
### AC-S005-2.2 — perf-smoke.sh wrapper
...
### AC-S005-2.3 — Threshold breach causes non-zero exit
...
### AC-S005-2.4 — verify.sh §6/6 advisory gate
...
### AC-S005-2.5 — Baseline doc exists
...
### AC-S005-2.6 — CI job runs perf-smoke
**Given** PR opened,
**When** CI runs,
...
### AC-S005-2.7 — Mock provider for /ask
...
### AC-S005-2.8 — JWT auth interaction (Sprint-4 cross-VS)
**Given** SPEC-S003-2 lands first in Sprint-4 (VS-19 before VS-20),
...
### AC-S005-2.9 — NaN-guarded JSON parsing
...
### AC-S005-2.10 — k6 1.0 binary pinned
**Given** Sprint-4 close,
...
### AC-S005-2.11 — AGPL note in docs
...
### AC-S005-2.12 — perf-smoke is opt-in for local dev
