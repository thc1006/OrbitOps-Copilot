# AC-S006-VS21 — Closed-loop GitOps reconcile

| Field | Value |
|---|---|
| Parent SPEC | SPEC-S006-VS21 |
...
### AC-S006-VS21.A1 — Safe action surface documented
**Given** SPEC-S006-VS21 §5.1,
...
### AC-S006-VS21.A2 — Apply mechanism decided in ADR-013
...
### AC-S006-VS21.A3 — Approval flow documented (no auto-apply)
**Given** SPEC §5.3,
**When** read,
...
### AC-S006-VS21.A4 — Observation harness bounded
**Given** SPEC §5.4,
**When** read,
...
### AC-S006-VS21.A5 — Rollback / Undo path defined
...
### AC-S006-VS21.A6 — Threat model populated
**Given** SPEC §5.6,
**When** read,
...
### AC-S006-VS21.A7 — ADR-004 extension committed
**Given** Sprint-4 sprint exit,
**When** `docs/adr/ADR-004-llm-grounding-contract.md` opened,
**Then** it has a new section / clause stating: "AI suggestions targeting cluster state mutations require explicit human approval; auto-apply is forbidden." (cross-references SPEC-S006-VS21 §5.3).

### AC-S006-VS21.A8 — Open questions enumerated for Sprint-5
**Given** SPEC §7,
...
### AC-S006-VS21.B1 — `/runbook` returns structured ActionPlan
...
### AC-S006-VS21.B2 — UI renders Apply / Dismiss for ActionPlan
...
### AC-S006-VS21.B3 — Apply triggers backend with audit
...
### AC-S006-VS21.B4 — Rate limit enforced
...
### AC-S006-VS21.B5 — Git commit lands on dedicated branch
...
### AC-S006-VS21.B6 — Whitelist-only action_id
...
### AC-S006-VS21.B7 — Observe returns metric ripple
...
### AC-S006-VS21.B8 — Undo round-trips
...
### AC-S006-VS21.B9 — kind smoke test exercises all 3 actions
...
### AC-S006-VS21.B10 — Anti-pattern self-audit on each impl PR
...
- AC-S006-VS21.C1 — Multi-cluster targeting
- AC-S006-VS21.C2 — Argo Image Updater integration (if image-tag rotation enters action surface)
- AC-S006-VS21.C3 — Cost-aware action ranking (cluster price impact)
