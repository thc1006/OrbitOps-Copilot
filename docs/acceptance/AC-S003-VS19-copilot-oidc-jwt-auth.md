# AC-S003-VS19 — copilot-api OIDC + JWT auth

| Field | Value |
|---|---|
| Parent SPEC | SPEC-S003-VS19 |
| Sprint | 4 (VS-19) |
...
### AC-S003-VS19.2 — Valid JWT returns 200 (existing behavior preserved)
...
### AC-S003-VS19.6 — `alg=HS256` token rejected
...
### AC-S003-VS19.8 — JWKS rotation is honored
...
### AC-S003-VS19.9 — `JWT_REQUIRED=false` disables verify (dev escape)
...
### AC-S003-VS19.10 — UI login flow stores token in localStorage
...
### AC-S003-VS19.11 — UI axios request interceptor injects bearer
...
### AC-S003-VS19.12 — UI 401 response clears token and redirects
...
### AC-S003-VS19.13 — Existing grounding/hallucination/injection tests still green with auth
**Given** auth enabled,
...
### AC-S003-VS19.14 — Total test count uplift
...
### AC-S003-VS19.15 — Anti-pattern self-audit on PR
